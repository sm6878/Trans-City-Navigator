...
int main()
{
    ...
    outtextxy(300,300,"LOCALITY NAVIGATOR");
    settextstyle(10,HORIZ_DIR,5);
    outtextxy(60,490,"SUBMITTED BY:");
    outtextxy(60,550,"ANURAG GUPTA  (17803028)");
    outtextxy(60,590,"SHUBHAM MISHRA(17803025)");
    outtextxy(60,630,"APOORV KUMAR  (17803010)");
    outtextxy(60,670,"KUNAL KANSIL  (17803026)");
    ...
    setcolor(BLUE);
    settextstyle(8,0,4);
    outtextxy(0,0,"FLY OVER");
    setcolor(YELLOW);
    outtextxy(185,0,"TRAFFIC FREE");
    setcolor(WHITE);
    outtextxy(440,0,"MARKET");
    setcolor(RED);
    outtextxy(620,0,"DAMAGED ROAD");
    setcolor(GREEN);
    outtextxy(960,0,"HOSPITAL");
